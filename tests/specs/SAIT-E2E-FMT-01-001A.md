...
> **Given** `INTERVIEW.md`, `stack/python-fastapi.md`, and `output/claude.md`
> are attached to an agent
> **When** the agent conducts the interview and generates output
> **Then** the result is a valid `CLAUDE.md` formatted per `output/claude.md`
...
| Result  | Condition                                                                                                    |
|---------|--------------------------------------------------------------------------------------------------------------|
| PASSED  | Output file is named `CLAUDE.md`; all required sections present; formatting follows `output/claude.md` rules |
...
1. Open Claude Code
2. Attach `INTERVIEW.md`, `stack/python-fastapi.md`, `output/claude.md`
...
2. Assert formatting follows `output/claude.md` rules
...
- Implements: `output/claude.md` formatting rules