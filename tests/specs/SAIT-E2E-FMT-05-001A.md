...
> **Given** `INTERVIEW.md`, `stack/python-fastapi.md`, and `formats/generic.md`
...
> `formats/generic.md` usable by any AI agent

## Results

| Result | Condition |
|--------|-----------|
| PASSED | Output filename is `AI_CONTEXT.md`; formatting follows `formats/generic.md`; all required sections present; no tool-specific formatting |
...
1. Open Claude Code
2. Attach `INTERVIEW.md`, `stack/python-fastapi.md`, `formats/generic.md`
...
1. Ask the agent:
   ...
   for this project. Use formats/generic.md for formatting rules.
   ```
...
2. Assert formatting follows `formats/generic.md` — no tool-specific syntax
