...
[DEPENDS ON: base/git.md, base/docs.md, base/quality.md, backend/config.md, backend/grpc.md, backend/concurrency.md, stack/go-service.md]
...
- Proto tooling: `buf`
- Config: per `stack/go-service.md`
