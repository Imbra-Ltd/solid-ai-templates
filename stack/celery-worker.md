# Stack — Celery Worker
[DEPENDS ON: base/git.md, base/docs.md, base/quality.md, backend/config.md, backend/jobs.md, backend/observability.md, backend/messaging.md, backend/quality.md, stack/python-lib.md]
